...
export class DangkyComponent implements OnInit {
	...
	check = false;;
	id: number = 4;
	username: string = "letronghung68";
	password: string = "Letronghung68";
	repass: string = "Letronghung68";
	fullname: string = "Lê Trọng Hưng";
	email: string = "jqksimon0608@gmail.com";
	gender: string = "true";
	birthday: string = "2000-08-06";
	schoolfee: number = 6800000;
	marks = 0;
